  ...
  return (
    ...
    <div>
        ...
        <header className="w-full py-8 bg-gray-100 shadow-md">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            ...
            <nav className="flex flex-col sm:flex-row flex-wrap items-center justify-between mt-4 md:mt-0 space-y-4 sm:space-y-0 sm:space-x-4">
              <div>
                <iframe
                  src="https://github.com/yashkusumkar02"
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Deepak Kusumkar</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Shubham</h4>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="py-8 bg-black text-white text-center">
        <p>© 2025 AI Mock Interview(Suyash Ksuumkar). All rights reserved.</p>
      </footer>
    </div>
  )
}
